...
const LoginScreen = ({ onGoogleLogin, onGithubLogin, signingIn }) => (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white px-4">
        ...
        <p className="text-lg text-gray-400 mb-8 text-center max-w-md">Your personal workout companion.</p>
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
            <button
                onClick={onGoogleLogin}
                disabled={signingIn}
                className="flex-1 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-bold py-3 px-6 rounded-lg flex items-center justify-center transition-colors text-base shadow"
            >
            ...
            <button
                ...
                disabled={signingIn}
                className="flex-1 bg-gray-800 hover:bg-gray-700 border border-gray-700 disabled:opacity-50 text-white font-bold py-3 px-6 rounded-lg flex items-center justify-center transition-colors text-base shadow"
            >
...
export default function App() {
    ...
    if (!user) {
        return <LoginScreen onGoogleLogin={handleGoogleSignIn} onGithubLogin={handleGithubSignIn} signingIn={signingIn} />;
    }
